...
public class Ex_13_1901015160 extends JFrame {
    final int windowWidth = 650;
    final int windowHeight = 900;

    public static void main(String[] args){
        new Ex_13_1901015160();
    }

    public Ex_13_1901015160() {
    ...
    public class MyJPanel extends JPanel implements ActionListener, MouseListener, MouseMotionListener {
        ...
        Image imgMe, imgEnemy, backgroundImage;
        JLabel label;
        ...
        public MyJPanel() {
            // 全体の設定
            //setBackground(new Color(41,240,112));
            ...
            iconEnemy = new ImageIcon("cloud01.jpg");
            imgEnemy = iconEnemy.getImage();
            enemyWidth = imgEnemy.getWidth(this);
            enemyHeight = imgEnemy.getHeight(this);

            backgroundImage = Toolkit.getDefaultToolkit().createImage("starBack.jpg"); 
            setOpaque(false);
